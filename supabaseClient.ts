...
-- ตารางการตั้งค่าระบบและหน่วยงานภายใน
CREATE TABLE IF NOT EXISTS school_configs (
  school_id TEXT PRIMARY KEY REFERENCES schools(id) ON DELETE CASCADE,
  drive_folder_id TEXT,
  script_url TEXT,
  ...
  external_agencies text[] DEFAULT '{}' -- สำหรับเก็บรายชื่อหน่วยงานต้นเรื่องที่ธุรการจัดการเอง
);
...
CREATE TABLE IF NOT EXISTS academic_sar (
  ...
  school_id TEXT REFERENCES schools(id) ON DELETE CASCADE,
  year TEXT NOT NULL,
  type TEXT NOT NULL, -- 'EARLY_CHILDHOOD' | 'BASIC'
